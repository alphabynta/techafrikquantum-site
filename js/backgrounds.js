...
(function () {
  ...
  /* ══════════════════════════════════════════════════════════════
     ...
     Color: Green #00e5a0  |  Used: home hero, safety section
  ══════════════════════════════════════════════════════════════ */
  function sceneDrones(canvas) {
    ...
    function draw() {
      ...
      for (let i = 1; i <= 4; i++) {
        ...
        ctx.strokeStyle = `rgba(${Cr},0.14)`;
        ctx.lineWidth = 1;
        ctx.stroke();
      }

      /* crosshairs */
      ctx.strokeStyle = `rgba(${Cr},0.10)`;
      ctx.lineWidth = 1;
      ...
      sg.addColorStop(0, `rgba(${Cr},0)`);
      sg.addColorStop(1, `rgba(${Cr},0.20)`);
      ctx.fillStyle = sg;
      ctx.fill();
      ctx.restore();
  ...
  /* ══════════════════════════════════════════════════════════════
     ...
     Color: Blue #00b4ff  |  Used: solutions hero, IP Networks section
  ══════════════════════════════════════════════════════════════ */
  ...
  /* ══════════════════════════════════════════════════════════════
     ...
     Color: Amber #f59e0b  |  Used: assets section, partners hero
  ══════════════════════════════════════════════════════════════ */
  function sceneFleet(canvas) {
    ...
    function draw() {
      ...
      ctx.fillStyle = 'rgba(6,4,2,0.12)';
      ctx.fillRect(0, 0, W, H);

      /* tactical grid */
      ctx.strokeStyle = `rgba(${Cr},0.07)`;
      ctx.lineWidth = 1;
      ...
      vehicles.forEach(v => {
        ...
        ctx.strokeStyle = `rgba(${Cr},0.18)`; ctx.lineWidth = 1;
        ctx.stroke();
        ctx.setLineDash([]);
        ctx.restore();
        ...
        for (let i = 1; i < v.trail.length; i++) {
          ...
          const col = v.alt ? `rgba(255,207,96,${a})` : `rgba(${Cr},${a})`;
          ctx.beginPath();
        ...
        if (v.pinging) {
          ...
          ctx.strokeStyle = `rgba(${Cr},${Math.max(0, 0.7 - v.pingR / 50)})`;
  ...
  /* ══════════════════════════════════════════════════════════════
     ...
     Color: Cyan #22d3ee  |  Used: connectivity section, about hero
  ══════════════════════════════════════════════════════════════ */
  function sceneComms(canvas) {
    ...
    function draw() {
      ...
      ctx.fillStyle = 'rgba(2,6,10,0.10)';
      ctx.fillRect(0, 0, W, H);
