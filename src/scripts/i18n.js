...
(function () {
  ...
  var translations = {
    ...
    ar: {
      ...
      'whoweare.detail': 'نصمم ونبني وننفذ حلول تكنولوجيا المعلومات والاتصالات عبر قطاعات الدفاع والحكومة والمؤسسات والاتصالات والتنقل والنفط والغاز. مهمتنا تمكين الحكومات والمؤسسات وقوات الأمن بحلول تكنولوجية عالمية — برؤية أن نصبح الشريك الأكثر ثقة في غرب أفريقيا للدفاع والأمن والاتصال. نسترشد بالموثوقية والنزاهة والتميز والشراكة طويلة الأمد في كل ما نقدمه.',
