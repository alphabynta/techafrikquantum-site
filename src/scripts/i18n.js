...
(function () {
  ...
  var translations = {
    en: {
      ...
      'defgov.body': 'Defense forces and public institutions operate where failure is not an option — in remote terrain, under adversarial conditions, with zero tolerance for downtime. We understand the security requirements, compliance frameworks, and operational pressures unique to this sector.',
      'defgov.li1': 'Armed forces & special operations units',
      'defgov.li2': 'National police, gendarmerie & border security',
      'defgov.li3': 'Smart city & public safety authorities',
      'defgov.li4': 'Government ministries & regulatory bodies',
      'defgov.li5': 'Public education & e-governance institutions',

      'enterprise.label': 'Enterprise',
      'enterprise.title': 'Enterprise',
      'enterprise.body': 'Businesses across West Africa face growing cyber threats, complex operations, and pressure to serve customers without disruption. We help enterprises stay secure, efficient, and competitive.',
      'enterprise.li1': 'Financial institutions, telcos & media companies',
      'enterprise.li2': 'Retail, distribution & multi-site operations',
      'enterprise.li3': 'Manufacturing & industrial operators',

      'oilgas.label': 'Oil & Gas',
      'oilgas.title': 'Oil & Gas',
      'oilgas.body': 'Extractive operations run in some of the most hostile and remote environments on the continent — where connectivity gaps, security risks, and asset losses translate directly into production downtime and financial exposure.',
      'oilgas.li1': 'Upstream exploration & offshore platforms',
      'oilgas.li2': 'Pipeline corridors & midstream infrastructure',
      'oilgas.li3': 'Downstream fuel distribution networks',

      'cellular.label': 'Cellular & Mobility',
      'cellular.title': 'Cellular & Mobility',
      'cellular.body': 'Mobile network operators need to push coverage further with less infrastructure. Logistics and transport companies need real-time visibility over their fleets. Both demand reliable technology built for Africa\'s operating reality.',
      'cellular.li1': 'Mobile network operators extending rural coverage',
      'cellular.li2': 'Regional & national logistics companies',
      'cellular.li3': 'Public transport authorities',
      'cellular.li4': 'Fuel distribution & tanker fleets',
      ...
      'partners.t3.body': '"The fleet tracking and fuel level monitoring system reduced our operational losses significantly within the first quarter of deployment."',
    ...
    fr: {
      ...
      'defgov.body': "Les forces de défense et les institutions publiques opèrent là où l'échec n'est pas une option — en terrain distant, dans des conditions adverses, sans tolérance pour les pannes. Nous comprenons les exigences sécuritaires, les cadres de conformité et les pressions opérationnelles propres à ce secteur.",
      'defgov.li1': 'Forces armées & unités des opérations spéciales',
      'defgov.li2': 'Police nationale, gendarmerie & sécurité des frontières',
      'defgov.li3': 'Autorités de ville intelligente & sécurité publique',
      'defgov.li4': 'Ministères & organismes de réglementation',
      'defgov.li5': 'Éducation publique & institutions d\'e-gouvernance',

      'enterprise.label': 'Entreprise',
      'enterprise.title': 'Entreprise',
      'enterprise.body': "Les entreprises d'Afrique de l'Ouest font face à des cybermenaces croissantes, des opérations complexes et une pression constante pour servir leurs clients sans interruption. Nous aidons les entreprises à rester sécurisées, efficaces et compétitives.",
      'enterprise.li1': 'Institutions financières, opérateurs télécoms & médias',
      'enterprise.li2': 'Commerce, distribution & opérations multi-sites',
      'enterprise.li3': 'Industrie manufacturière & opérateurs industriels',

      'oilgas.label': 'Pétrole & Gaz',
      'oilgas.title': 'Pétrole & Gaz',
      'oilgas.body': "Les opérations extractives se déroulent dans certains des environnements les plus hostiles et reculés du continent — où les lacunes de connectivité, les risques sécuritaires et les pertes d'actifs se traduisent directement par des arrêts de production et une exposition financière.",
      'oilgas.li1': 'Exploration en amont & plateformes offshore',
      'oilgas.li2': 'Corridors de pipelines & infrastructure midstream',
      'oilgas.li3': 'Réseaux de distribution de carburant en aval',

      'cellular.label': 'Cellulaire & Mobilité',
      'cellular.title': 'Cellulaire & Mobilité',
      'cellular.body': "Les opérateurs de réseaux mobiles doivent étendre leur couverture avec moins d'infrastructure. Les entreprises de logistique et de transport ont besoin d'une visibilité en temps réel sur leurs flottes. Les deux exigent une technologie fiable adaptée à la réalité opérationnelle africaine.",
      'cellular.li1': 'Opérateurs de réseaux mobiles étendant la couverture rurale',
      'cellular.li2': 'Entreprises de logistique régionales & nationales',
      'cellular.li3': 'Autorités de transport public',
      'cellular.li4': 'Distribution de carburant & flottes de camions-citernes',
      ...
      'partners.t3.body': '"Le système de suivi de flotte et de surveillance du niveau de carburant a significativement réduit nos pertes opérationnelles dès le premier trimestre de déploiement."',
    ...
    ar: {
      ...
      'defgov.body': 'تعمل قوات الدفاع والمؤسسات العامة حيث الفشل ليس خياراً — في تضاريس نائية، في ظروف معادية، مع عدم تسامح مطلق مع أي توقف. نحن نفهم المتطلبات الأمنية وأطر الامتثال والضغوط التشغيلية الخاصة بهذا القطاع.',
      'defgov.li1': 'القوات المسلحة ووحدات العمليات الخاصة',
      'defgov.li2': 'الشرطة الوطنية والدرك وأمن الحدود',
      'defgov.li3': 'سلطات المدن الذكية والسلامة العامة',
      'defgov.li4': 'الوزارات الحكومية والهيئات التنظيمية',
      'defgov.li5': 'التعليم العام ومؤسسات الحوكمة الإلكترونية',

      'enterprise.label': 'المؤسسات',
      'enterprise.title': 'المؤسسات',
      'enterprise.body': 'تواجه الشركات في غرب أفريقيا تهديدات إلكترونية متنامية وعمليات معقدة وضغطاً لخدمة عملائها دون انقطاع. نساعد المؤسسات على البقاء آمنة وفعّالة وتنافسية.',
      'enterprise.li1': 'المؤسسات المالية وشركات الاتصالات والإعلام',
      'enterprise.li2': 'التجارة والتوزيع والعمليات متعددة المواقع',
      'enterprise.li3': 'الصناعة التحويلية والمشغلون الصناعيون',

      'oilgas.label': 'النفط والغاز',
      'oilgas.title': 'النفط والغاز',
      'oilgas.body': 'تعمل العمليات الاستخراجية في بعض أعدى البيئات وأكثرها نأياً في القارة — حيث تُترجَم فجوات الاتصال والمخاطر الأمنية وخسائر الأصول مباشرةً إلى توقف الإنتاج والتعرض المالي.',
      'oilgas.li1': 'الاستكشاف في المنبع والمنصات البحرية',
      'oilgas.li2': 'ممرات خطوط الأنابيب والبنية التحتية للمجرى المتوسط',
      'oilgas.li3': 'شبكات توزيع الوقود في المصب',

      'cellular.label': 'الخلوي',
      'cellular.title': 'الخلوي',
      'cellular.body': 'يحتاج مشغلو الشبكات المحمولة إلى توسيع تغطيتهم بأقل قدر من البنية التحتية. تحتاج شركات اللوجستيات والنقل إلى رؤية فورية على أسطولها. كلاهما يتطلب تقنية موثوقة مبنية لواقع أفريقيا التشغيلي.',
      'cellular.li1': 'مشغلو الشبكات المحمولة الساعون لتوسيع التغطية الريفية',
      'cellular.li2': 'شركات اللوجستيات الإقليمية والوطنية',
      'cellular.li3': 'هيئات النقل العام',
      'cellular.li4': 'توزيع الوقود وأساطيل الشاحنات الصهريجية',
      ...
      'partners.t3.body': '"خفّض نظام تتبع الأسطول ومراقبة مستوى الوقود خسائرنا التشغيلية بشكل ملحوظ خلال الربع الأول من النشر."',
